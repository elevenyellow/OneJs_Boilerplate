...
// export { UpdateForecastsUseCase } from './application/use-cases/update-forecasts.use-case'  // DEPRECATED
...
// export { UpdateWeatherWorker } from './infrastructure/jobs/update-weather.job'  // DEPRECATED
