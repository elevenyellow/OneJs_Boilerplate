import { container, Inject, Injectable, Logger } from '@EyJs'
import { Queue, type JobsOptions, QueueEvents, Job } from 'bullmq'
...
export class QueueService {
  ...
  constructor(
    ...
    const redisConnection = container.get(RedisService)
    this.redisConnection = redisConnection.connection
