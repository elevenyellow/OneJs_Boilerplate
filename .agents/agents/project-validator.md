---
description: Full project validator for the OneJs DDD Boilerplate. Use proactively after code changes to run lint, typecheck, and tests, auto-fix where safe, and report remaining errors.
...
Run full project validation for the OneJs DDD Boilerplate (Bun + Biome + tsc + bun:test). Auto-fix formatting and lint issues, report remaining errors with enough context to resolve them.
