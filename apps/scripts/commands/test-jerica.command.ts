/**
 * Comando: test-jerica
 * Scrape solo el crag de Jérica (Castellón, Valencia) para testing
 *
...
// Jérica IDs from TheCrag
const JERICA_ID = 102885390 // Jérica crag
const COMUNIDAD_VALENCIANA_ID = 22687829 // Valencia region
const SPAIN_ID = 16227917
const EUROPE_ID = 7546062

export async function testJerica(container: unknown, cookie: string) {
  ...
  console.log('🏔️  TEST JÉRICA - Verificación de imágenes de sectores y topos')
  ...
  try {
    ...
    console.log('📍 Step 3: Ejecutando scraper para Jérica...')
...
function printFinalReport(result: ImportResult, duration: string) {
  console.log('')
  console.log('='.repeat(80))
  console.log('🎉 TEST JÉRICA COMPLETADO')
  console.log('='.repeat(80))
  console.log('')
  console.log('📊 RESUMEN:')
