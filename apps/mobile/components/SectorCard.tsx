...
export const SectorCard = memo(
  function SectorCard({ result, compact = false }: SectorCardProps) {
    ...
    const buildNavigationPath = () => {
      ...
      if (sector.tags) {
        if (
          sector.tags.kidFriendly !== null &&
          sector.tags.kidFriendly !== undefined
        ) {
            ...
            <View style={styles.compactIconWrapper}>
              ...
              <View
                style={[
                  ...
                  { backgroundColor: orientationInfo.color },
                ]}
              >
            ...
            <View style={styles.compactInfo}>
              ...
              <View style={styles.compactStatsRow}>
                <View style={styles.compactStatItem}>
                  ...
                  <Text
                    style={[styles.compactStatText, { color: colors.text }]}
                  >
                    {routesInUserRange}
                  </Text>
                  <Text
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
            {routesInUserRange} routes in your range •{' '}
            {sector.routes?.length || 0} total
          </Text>
