...
function getWeatherIcon(
  ...
  const hasActualPrecipitation = precipitation !== undefined && precipitation > 0
...
export function WeatherDetailScreen({
  ...
  // Filter hourly to show from current hour onwards (next 24 hours)
  const now = new Date()
                  ...
                  >
                    ...
                    >
                      ...
                      <View style={styles.dayCardConditionRow}>
                        ...
                        >
                          {Math.round(day.wind?.mean || 0)}km/h
                        </Text>
                      </View>
                    </View>
                  </View>
